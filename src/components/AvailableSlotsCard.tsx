...
export const AvailableSlotsCard = ({ params, loading }: AvailableSlotsCardProps) => {
  ...
  if (error) {
    return (
      <Card className="w-full bg-gradient-to-br from-destructive/10 via-background to-destructive/5 border-destructive/20">
        <CardContent className="pt-6">
          <div className="flex items-center gap-3 mb-4">
  ...
  return (
    <Card className="w-full bg-gradient-to-br from-primary/10 via-background to-secondary/10 border-primary/20 shadow-lg">
      <CardContent className="pt-6">
